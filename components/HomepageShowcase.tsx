...
// Homepage Showcase V5 — Premium scroll gallery with alternating sections and scroll-reveal animations
// Adapted from Framer Code Component for Next.js
...
.hs5-card{background:${T.card};border:1px solid ${T.border};border-radius:var(--hs5-r,12px);width:100%;max-width:440px;overflow:hidden;box-shadow:0 4px 24px ${T.shadow};position:relative;transition:box-shadow 0.4s ease,transform 0.4s ease}
...
@keyframes hs5-pulse{0%,100%{opacity:0.3}50%{opacity:0.7}}
...
@keyframes hs5-dot-pulse{0%,100%{transform:translate(-50%,-50%) scale(1);opacity:1}50%{transform:translate(-50%,-50%) scale(1.5);opacity:0.5}}
...
const labelStyle = (size = 11, color = "#888", weight = 600, ls = "0.08em") => ({
    fontFamily: F,
    fontSize: size,
    fontWeight: weight,
    letterSpacing: ls,
...
const bodyStyle = (size = 13, color = "#fff", weight = 400) => ({
    fontFamily: F,
    fontSize: size,
    fontWeight: weight,
    color,
    ...
    return (
        <div className="hs5-card" style={{ padding: 28 }}>
            <div style={{ textAlign: "center", marginBottom: 20 }}>
                <div style={labelStyle(11, t.sub)}>WAYS TO EARN POINTS</div>
                <div style={{ ...bodyStyle(12, t.sub), marginTop: 5 }}>
            ...
            >
                {earnCards.map((c, i) => (
                    ...
                    >
                        ...
                        <div
                            style={{
                                ...bodyStyle(12, t.text, 700),
                                lineHeight: 1.3,
                            }}
                        >
                            {c.title}
                        </div>
                        <div style={{ ...bodyStyle(11, t.sub) }}>
                            {c.done ? "earned " : "earn "}
                            {c.points}
                        </div>
                        {c.done ? (
    ...
    return (
        <div className="hs5-card" style={{ padding: 0 }}>
            ...
            >
                ...
                >
                    <div style={{ ...labelStyle(10, t.text), opacity: 0.7 }}>
                        CURRENT TIER
                    </div>
                    <div
                        style={{
            ...
            >
                ...
                >
                    ...
                    <div>
                        <div style={{ ...bodyStyle(14, t.text, 700) }}>
                            ENTHUSIAST
                        </div>
                        <div style={{ ...bodyStyle(12, t.sub), marginTop: 2 }}>
                            Spend $200
                        </div>
                    </div>
                </div>
                {benefits.map((b, i) => (
                    ...
                    >
                        ...
                        <span style={{ ...bodyStyle(12, t.sub) }}>{b}</span>
                    </div>
                ))}
            </div>
        </div>
...
function ReferralsCreative() {
    ...
    return (
        <div className="hs5-card" style={{ padding: 28 }}>
            <div style={labelStyle(11, A)}>REFER A FRIEND</div>
            <div
                style={{
                    ...bodyStyle(24, t.text, 700),
                    letterSpacing: "-0.02em",
                    margin: "10px 0 6px",
                }}
            >
            ...
            <div style={{ ...bodyStyle(13, t.sub), marginBottom: 22 }}>
            ...
            >
                <span style={{ ...bodyStyle(13, t.sub) }}>Your friend&apos;s email</span>
            </div>
            <div
                style={{
                    padding: "9px 18px",
            ...
            <div>
                <div style={{ ...bodyStyle(12, t.sub), marginBottom: 8 }}>
                    ...
                    {socials.map((s, i) => (
                        <div
                            ...
                            style={{
                                ...
                                alignItems: "center",
                                justifyContent: "center",
                                ...bodyStyle(12, i === refPhase ? A : t.text, 600),
                ...
                {options.map((o, i) => {
                    ...
                    <div
                        ...
                        style={{
                            ...
                            ...bodyStyle(13, isActive ? T.bg : t.text, 600),
                            letterSpacing: "0.04em",
                            minWidth: 120,
                            textAlign: "center",
                            cursor: "pointer",
        ...
        <div className="hs5-card" style={{ padding: 0, overflow: "hidden" }}>
            <div style={{ padding: "24px 28px 28px", background: t.card2 }}>
                ...
                >
                    <div
                        style={{
                            ...
                            background: t.pillBg,
                            borderRadius: "var(--hs5-r, 12px)",
                            ...labelStyle(10, t.text, 600, "0.04em"),
                        }}
                    >
                        Subscriber
                    </div>
                    <div style={{ ...bodyStyle(12, t.sub) }}>
                        Month {currentMonth} of 12
                    </div>
                </div>
                <div
                    style={{
                        ...bodyStyle(18, t.text, 700),
                ...
                <div style={{ marginBottom: 24 }}>
                    ...
                    >
                        <span style={{ ...bodyStyle(10, t.sub, 500) }}>Month 1</span>
                        <span style={{ ...bodyStyle(10, A, 600) }}>Month 6</span>
                        <span style={{ ...bodyStyle(10, t.sub, 500) }}>
                            Month 12
                        </span>
                    </div>
                </div>
                ...
                >
                    ...
                    >
                        <div style={labelStyle(9, t.sub, 500, "0.06em")}>
                            MILESTONE REWARD
                        </div>
                        <div
                            style={{
                                ...bodyStyle(15, t.text, 700),
                                lineHeight: 1.3,
                            }}
                        >
                            Skincare Serum
    ...
    return (
        <div className="hs5-card" style={{ padding: 0 }}>
            <div style={{ background: t.headerBg, padding: "24px 24px 22px" }}>
                ...
                >
                    <div style={labelStyle(10, t.sub)}>POINTS</div>
                    <div
                        style={{
                            ...bodyStyle(24, t.text, 700),
                            animation: "hs5-breathe 3s ease-in-out infinite",
                ...
                >
                    <div>
                        <div style={labelStyle(9, t.sub, 500, "0.06em")}>MEMBER</div>
                        <div style={{ ...bodyStyle(14, t.text, 500), marginTop: 3 }}>
                            Stephanie O.
                        </div>
                    </div>
                    <div style={{ textAlign: "right" }}>
                        <div style={labelStyle(9, t.sub, 500, "0.06em")}>TIER</div>
                        <div style={{ ...bodyStyle(14, t.text, 500), marginTop: 3 }}>
                            Enthusiast
                        </div>
                    </div>
            ...
            >
                <div
                    style={{
                        ...
                        background: t.pillBg,
                        borderRadius: "var(--hs5-r, 12px)",
                        ...labelStyle(10, t.text, 600, "0.06em"),
                        marginBottom: 8,
                    }}
                >
                    RECENT ACTIVITY
                ...
                {[
                    ...
                    >
                        <div>
                            <div style={{ ...bodyStyle(13, t.text) }}>
                                {item.action}
                            </div>
                            <div style={{ ...bodyStyle(11, t.sub), marginTop: 2 }}>
                                {item.time}
                            </div>
                        </div>
                        <div
            ...
            >
                ...
                />
                <span style={{ ...bodyStyle(12, t.sub, 500) }}>
...
const CREATIVES: React.ComponentType<any>[] = [
    RewardsCreative,
    TiersCreative,
    ReferralsCreative,
    GamifiedCreative,
...
export default function HomepageShowcase({
    ...
    const sections = Array.from({ length: count }, (_, i) => ({
        title: titles[i] || DEFAULT_TITLES[i] || `Section ${i + 1}`,
        desc: descriptions[i] || DEFAULT_DESCRIPTIONS[i] || "",
        link: links[i] || DEFAULT_LINKS[i] || "#",
    }))
    ...
    return (
        <ThemeCtx.Provider value={T}>
            ...
            <div
                ...
                style={{
                    ["--hs5-desc-size" as string]: `${descriptionSize}px`,
                    ["--hs5-title-size" as string]: `${titleSize}px`,
                    ["--hs5-r" as string]: `${borderRadius}px`,
