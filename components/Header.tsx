    ...
    >
      ...
      >
        ...
        <div ref={logoRef} style={{ position: "relative", flexShrink: 0 }}>
          ...
          >
            <svg viewBox="0 0 123 55" fill="none" style={{ width: "56px", height: "25px" }}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: "36px" }}>
          ...
          <a
            ...
            style={{
              ...
              color: "#0F2E2F",
              textDecoration: "none",
              backgroundColor: shopHov ? "#38d37e" : "#43E484",
              borderRadius: "999px",
              padding: "10px 22px",
              lineHeight: 1,
          ...
          <a href="#" style={{ display: "flex", alignItems: "center", textDecoration: "none" }}>
            <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#0F2E2F" strokeWidth="1.4" strokeLinecap="round" strokeLinejoin="round">
